const LEJEASIDE = document.getElementById("leje1");
...
const LEJEASIDE2 = document.getElementById("leje2");

LEJEASIDE2.insertAdjacentHTML("beforeend", `<br><br><h3>Udstyrsvalg</h3><ul id="ekstraudstyr">`);
LEJEASIDE2.insertAdjacentHTML("beforeend", `<img src="${sessionStorage.getItem('billede')}" alt="bilens billede">`);
